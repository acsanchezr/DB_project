...
<div class="item2">
  ...
  <p class="lead">
    ...
    <a class="btn btn-primary btn-lg" href="./display_functions/display_tow_truck.php" role="button">Display tow trucks</a></br></br>
    <a class="btn btn-primary btn-lg" href="./update_functions/edit_towtruck_form.php" role="button">Update a tow truck</a></br></br>
